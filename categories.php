...
<ul class="nav nav-pills nav-stacked">
  ...
  <li><a href="categories.php" style= "color:#610000"><span class="glyphicon glyphicon-list-alt"></span> Categories</a></li>
    ...
    <tbody>
      ...
      <tr>
       ...
       <form class="form-horizontal" role="form">
        ...
        <button type="button" class="btn btn-default col-sm-offset-1"> <span class="glyphicon glyphicon-trash"></span> Discard</button>
	    <button type="button" class="btn btn-default  "> <span class="glyphicon glyphicon-ok"></span> Save </button>
    </div>
	   </form> 
	<p><b>Add Existing Item to Category:</b></p>
