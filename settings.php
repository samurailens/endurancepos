...
<ul class="nav nav-pills nav-stacked">
  <li ><a href="settings.php" style= "color:#610000"><span class="glyphicon glyphicon-user"></span> Manage Users</a></li>
...
<!--       <tr>
     ...
     <button id="save" class="btn btn-success" onclick="saveUserMods();" type="button"><span class="glyphicon glyphicon-floppy-disk"></span> Save</button>   
</div>
</div>
  </div>
</div>
