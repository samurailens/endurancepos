	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9" style="background-color: lavenderblush;">
				<div class="container">
					<form class="form-horizontal" method="POST" action="sessionmanager.php" role="form">
						<div class="form-group">
							<label class="control-label col-sm-2" for="email">Email:</label>
							<div class="col-sm-6">
								<input type="email" class="form-control" id="email" name="emailsignin"
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="password" class="form-control" id="pwd" name="passwordsignin" 
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-6">
								<button type="submit" name="signinbutton" class="btn btn-default">Submit</button>
							</div>
						</div>
					</form>
				</div>
