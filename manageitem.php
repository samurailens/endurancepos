...
<ul class="nav nav-pills nav-stacked">
  ...
  <li><a href="manageitem.php" style= "color:#610000"><span class="glyphicon glyphicon-plus"></span> Manage Item</a></li>
...
<br/>
  ...
  <table class="table table-striped" id="existing_items_list_in_db" >
   ...
   <button id="save" class="btn btn-success" onclick="saveNewPrices();" type="button" ><span class="glyphicon glyphicon-floppy-disk"></span> Save</button>   
</div>
