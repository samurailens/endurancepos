...
<div class="input-group">
    ...
    <label class="radio-inline">
      <input type="radio" id="dinein-radio" name="optradio" value="ordertype_dinein" ><span class="glyphicon glyphicon-cutlery"></span> Dine in
    </label>
    <label class="radio-inline">
      <input type="radio" id="delivery-radio" name="optradio" value="ordertype_delivery" ><span class="glyphicon glyphicon-gift"></span> Delivery
    </label>
    <label class="radio-inline">
      <input type="radio" id="pickup-radio" name="optradio" value="ordertype_pickup"><span class="glyphicon glyphicon-phone-alt"></span> Pickup
    </label>
  </form>
  </div>
  <br/>
<div class="input-group">
  ...
  <ul class="nav nav-tabs">
    <li id="starters"  onclick="activateMenu(this);" ><a href="#"  style = "color:#660000">Starters</a></li>
    <li id="maincourse"  onclick="activateMenu(this);" ><a href="#" style = "color:#660000">Main Course</a></li>
    <li id="desserts"  onclick="activateMenu(this);" ><a href="#" style = "color:#660000">Desserts</a></li>
    <li id="beverages"  onclick="activateMenu(this);" ><a href="#" style = "color:#660000">Beverages</a></li>
  </ul>
  <ul class="list-group" >
	  <div id="result">
	...
	<p><b> <span class="glyphicon glyphicon-bookmark"></span> Recent Orders </b></p>
<div class="list-group" >
 ...
 <!--  <a href="#" class="list-group-item list-group-item-success">11233 - Idly, Vada, Coffee - Rs 120</a>
  ...
  <a href="#" class="list-group-item list-group-item-success">11231 - Kharabath, Coffee, Tea - Rs 80</a> -->
	...
	<br/>
	<p><b> <span class="glyphicon glyphicon-plane"></span> Quick Order </b></p>
	<ul class="list-group">
  ...
  <div class="input-group col-xs-offset-6">
   <span class="input-group-btn" >
        <button class="btn btn-primary" id="checkoutBtn" type="button" onclick="checkOutOrder()" ><span class="glyphicon glyphicon-shopping-cart"></span> Check Out</button>
		<button class="btn btn-success" id="confirmOrderBtn" style="display:none"  type="button" onclick="confirmOrder()" ><span class="glyphicon glyphicon-shopping-cart"></span> Confirm Order </button>
		<br/><button class="btn btn-warning	" id="cancelOrderBtn" style="display:none"  type="button" onclick="cancelOrder()" ><span class="glyphicon glyphicon-shopping-cart"></span> Cancel Order </button>
   </span>
  </div>
</div>
</div>
