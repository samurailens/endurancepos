		...
		<div class="row">
			...
			<div class="col-sm-3">
				<ul class="nav nav-pills nav-stacked">
					...
					<li><a href="tax.php" style="color: #610000"><span
							class="glyphicon glyphicon-euro"></span> Tax</a></li>
			...
			<div class="col-sm-8" style="background-color: lavender">
				...
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						<label class="control-label col-sm-3" for="ServiceTax">Service Tax
							(%)</label>
						<div class="col-sm-6">
				...
				<div class="form-group">
					<div class="col-sm-offset-3 col-sm-6">
						<button type="submit" class="btn btn-default"
							onclick="saveTaxChanges();">Submit</button>
					</div>
				</div>
			</div>
