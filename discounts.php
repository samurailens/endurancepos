		...
		<div class="row">
			...
			<div class="col-sm-3">
				<ul class="nav nav-pills nav-stacked">
					...
					<li><a href="tax.php"><span class="glyphicon glyphicon-euro"></span>
							Tax</a></li>
					<li><a href="discounts.php" style="color: #610000"><span
							class="glyphicon glyphicon-gift"></span> offers and discounts</a></li>
				</ul>
			</div>
			...
			<div class="col-sm-8" style="background-color: lavenderblush">
				...
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						<label class="control-label col-sm-3" for="Category">Select
							Category</label>
						<div class="col-sm-6">
						...
						<button type="button" class="btn btn-default"
							data-toggle="collapse" data-target="#demo3">>> Display items</button>
